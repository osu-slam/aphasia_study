...
%% File names
ResultsXls = fullfile(dir_results, 'post_screen_10Jul18', 'exp_laptop_results.xlsx'); 
Variables  = fullfile(dir_results, 'post_screen_10Jul18', 'exp_laptop_variables.mat');
